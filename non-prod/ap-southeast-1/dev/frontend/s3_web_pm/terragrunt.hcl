locals {
  ...
  web_domain      = local.environment_vars.locals.web_pm_domain
  web_bucket      = local.environment_vars.locals.web_pm_bucket
...
dependency "waf_web" {
  config_path = find_in_parent_folders("waf_web_pm")
  mock_outputs = {
