locals {
  ...
  web_domain      = local.environment_vars.locals.dh_web_tk_domain
  web_bucket      = local.environment_vars.locals.web_tk_bucket
...
dependency "waf_web_tk" {
  config_path = find_in_parent_folders("waf_web_tk")
  mock_outputs = {
...
dependencies {
  paths = ["../../acm_dh_tenant", "../waf_web_tk"]
}
...
inputs = {
  ...
  waf_acl_id              = dependency.waf_web_tk.outputs.waf_arn
