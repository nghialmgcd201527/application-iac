locals {
  ...
  repo_name      = local.environment_vars.locals.core_service_repo
  stage          = local.environment_vars.locals.stage
  container_port = local.environment_vars.locals.core_service_port
  short_name     = local.environment_vars.locals.core_service_short_name
...
inputs = {
  ...
  ecs_cluster_name            = "bizbone-cluster-qa"
