locals {
  ...
  repo_name      = local.environment_vars.locals.am_api_repo
  stage          = local.environment_vars.locals.stage
  container_port = local.environment_vars.locals.am_service_port
  short_name     = local.environment_vars.locals.am_api_repo_short_name
