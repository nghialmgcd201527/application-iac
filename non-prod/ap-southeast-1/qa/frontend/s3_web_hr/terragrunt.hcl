locals {
  ...
  web_domain      = local.environment_vars.locals.dh_web_hr_domain
  web_bucket      = local.environment_vars.locals.web_hr_bucket
...
dependency "waf_web_identity" {
  config_path = find_in_parent_folders("waf_web_hr")
  mock_outputs = {
...
dependencies {
  paths = ["../../acm_dh_tenant", "../waf_web_hr"]
}
