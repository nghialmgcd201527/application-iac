locals {
  ...
  web_domain      = local.environment_vars.locals.dh_web_pr_domain
  web_bucket      = local.environment_vars.locals.web_pr_bucket
...
dependency "waf_web_pr" {
  config_path = find_in_parent_folders("waf_web_pr")
  mock_outputs = {
...
dependencies {
  paths = ["../../acm_dh_tenant", "../waf_web_pr"]
}
...
inputs = {
  ...
  waf_acl_id              = dependency.waf_web_pr.outputs.waf_arn
