locals {
  ...
  web_domain      = local.environment_vars.locals.dh_web_rm_domain
  web_bucket      = local.environment_vars.locals.web_rm_bucket
...
dependency "acm" {
  config_path = find_in_parent_folders("acm_dh_tenant")
  mock_outputs = {
...
dependency "waf_web_identity" {
  config_path = find_in_parent_folders("waf_web_rm")
  mock_outputs = {
...
dependencies {
  paths = ["../../acm_dh_tenant", "../waf_web_identity"]
}
