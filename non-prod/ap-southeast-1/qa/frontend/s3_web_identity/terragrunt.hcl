locals {
  ...
  web_domain      = local.environment_vars.locals.dh_web_identity_domain
  web_bucket      = local.environment_vars.locals.web_identity_bucket
...
dependency "waf_web_identity" {
  config_path = find_in_parent_folders("waf_web_identity")
  mock_outputs = {
...
dependencies {
  paths = ["../../acm_datahouseasia", "../waf_web_identity"]
}
