locals {
  ...
  web_domain      = local.environment_vars.locals.web_rq_domain
  web_bucket      = local.environment_vars.locals.web_rq_bucket
...
dependency "waf_web_identity" {
  config_path = find_in_parent_folders("waf_web_rq")
  mock_outputs = {
